    ...
    <main>
      <table>
        <tr>
          ...
          <th width="100px">Medical Info<br><hr></th>
          <th width="100px">Class ID<br><hr></th>
          <th width="100px">Parent 1 ID<br><hr></th>
          <th width="100px">Parent 2 ID<br><hr></th>
        </tr>
        <?php 
        ...
        $sql = mysqli_query($link, "SELECT StudentID, FirstName, LastName, Address, MedicalInformation, ClassID, Parent1ID, Parent2ID FROM Students");
