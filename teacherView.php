...
<html>
  ...
  <body>
    ...
    <main>
      <table>
        <tr>
          <th width="100px">TeacherID<br><hr></th>
          ...
          <th width="100px">BackgroundCheck<br><hr></th>
        ...
        $sql = mysqli_query($link, "SELECT TeacherID, FirstName, LastName, Address, Email, ClassID, BackgroundCheck FROM Teachers");
